...
return [
    ...
    'title' => 'Allo Delivery API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API de la plateforme Allo Delivery — gestion des livraisons, profils de livreurs, suivi en temps réel, chat et paiements.',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'api/drivers/{slug}/register',
                'PUT api/ai-request-drafts/{ai_request_draft}',
                'PATCH api/ai-request-drafts/{ai_request_draft}',
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Token Sanctum Bearer. Récupérez-le via `/api/register` ou `/api/login` (champ `token` de la réponse).',
    ],
