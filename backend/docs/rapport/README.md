...
- Branches : `feature/Queue-Jobs` (AR-30) → `feature/DashbordDriver` (AR-39) → `feature/PDF` (AR-37, PDF annulé) → **`feature/Reverb` (F12 diffusion temps réel, poussée)**
- PR : https://github.com/Rayantoufella/Allo_Delevry/pull/new/feature/Reverb · https://github.com/Rayantoufella/Allo_Delevry/pull/new/feature/PDF